...
def main():
    ...
    eco.add_argument('--soil-limits', action='store_true', help='Shared nutrient budgets limit growth; soil recovers over time')
    eco.add_argument('--water', action='store_true', help='River, rain and moisture limit growth; enables soil budgets')
        ...
        if a.command == 'run':
            ...
            if a.command == 'contest':
                ...
                kwargs.update(mode='ecosystem', agents=a.agents, patches=a.patches,
                              ...
                              lifetime_learning=a.lifetime_learning, gardening=a.gardening, soil_limits=a.soil_limits, water=a.water,
